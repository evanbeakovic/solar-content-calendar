...
interface SMMNavbarProps {
  profile: Profile
}

export default function SMMNavbar({ profile }: SMMNavbarProps) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#10375C] text-white h-16 flex items-center px-6 shadow-lg">
      <div className="flex items-center gap-3">
        ...
        <span className="text-[#8EE3E3] text-xs font-medium bg-[#8EE3E3] bg-opacity-10 px-2 py-0.5 rounded-full border border-[#8EE3E3] border-opacity-20">SMM</span>
      </div>
