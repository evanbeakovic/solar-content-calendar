...
export default function PostCard({ post, onClick, onStatusChange, onSelect, isSelected, isSelectionMode, onDuplicated, onDeleted }: PostCardProps) {
  ...
  return (
    <div
      ...
      className={`relative bg-white rounded-xl shadow-sm border transition-all cursor-pointer group overflow-hidden flex flex-col ${
        isSelected
      ...
      <div className="p-3 flex flex-col flex-1">
        ...
        {imageUrl && (
          <button
            ...
            className="mb-1 w-full text-xs py-1.5 rounded-lg font-medium transition-all flex items-center justify-center gap-1 border border-gray-200 text-gray-500 hover:bg-gray-50"
          >
      ...
      {showRequestNoteModal && (
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-700 leading-relaxed mb-4">{post.change_request_note}</p>
            {hasChangeImages && (
              <div>
